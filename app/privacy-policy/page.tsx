  ...
  return (
    <Container>
      ...
      <div className="mb-4">
        ...
        <p>
          At Sqwadz, we value the privacy of our users and are committed to
          protecting your personal information. This Privacy Policy outlines how
          we collect, use, and safeguard the information you provide when using
          our website (https://sqwadz.com/) and services.
        </p>
      </div>
      <div className="mb-4">
        ...
        <p>
          ...
          and other contact details when you create an account or interact with
          our services. We may also collect non-personal information such as
          your device information, browsing data, and usage statistics.
        </p>
      </div>
      <div className="mb-4">
        ...
        <p>
          ...
          our services, as well as for communication purposes, analytics, and
      ...
      <div className="mb-4">
        ...
        <p>
          ...
          in operating our website and delivering our services. We may also
          disclose your information as required by law or to protect our rights
          and interests.
        </p>
      </div>
      <div className="mb-4">
      ...
      <div className="mb-4">
        ...
        <p>
          ...
          are not governed by this Privacy Policy. We encourage you to review
